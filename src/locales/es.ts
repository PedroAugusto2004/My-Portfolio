...
export const es: Translations = {
    ...
    certifications: {
        items: [
            { id: "cs50x", name: "CS50x: Introducción a la Informática", issuer: "Universidad de Harvard" },
            { id: "cs50ai", name: "CS50AI: Introducción a la Inteligencia Artificial con Python", issuer: "Universidad de Harvard" },
            { id: "cs50c", name: "CS50C: Introducción a la Ciberseguridad", issuer: "Universidad de Harvard" },
            { id: "fcc-frontend", name: "Certificación de Desarrollo Front End", issuer: "freeCodeCamp" },
            { id: "dio", name: "100+ horas de capacitación", issuer: "DIO (desarrollo web, nube, ingeniería de software)" },
        ]
    },
    achievements: {
        items: [
        ...
        items: [
            ...
            },
            {
                ...
                projectLinks: [
                    ...
                    { name: "Visitar Sitio Web", url: "https://www.studyshield.site/" }
                ],
            },
            {
                id: "megaphoton",
                ...
                projectLinks: [
                    { name: "Ver Código en GitHub", url: "https://github.com/PedroAugusto2004/megaphoton" },
                    { name: "Visitar Sitio Web", url: "https://www.megaphoton.com.br/" }
                ]
            },
            {
                id: "medimentor",
                ...
                projectLinks: [
                    { name: "Ver Código en GitHub", url: "https://github.com/PedroAugusto2004/MediMentor" },
                    { name: "Visitar Sitio Web", url: "https://main.do8zwgfpt20yc.amplifyapp.com" }
                ]
            },
            {
                id: "muscles",
                ...
                projectLinks: [
                    { name: "Ver Código en GitHub", url: "https://github.com/PedroAugusto2004/Muscles-e-Balance" },
                    { name: "Visitar Sitio Web", url: "https://muscles-and-balance-7.web.app" }
                ]
            },
        ],
    },
